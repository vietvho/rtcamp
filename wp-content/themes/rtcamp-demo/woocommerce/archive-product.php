...
$page_layout = wan_choose_opt('woocommerce_layout');
?>
<div class="row pt-30 <?php echo esc_attr(wan_choose_opt('layout_version'));?>">
...
echo do_blocks(get_the_content(null,false,get_option( 'woocommerce_shop_page_id' )));
get_footer( 'shop' );
