...
if ( ! $checkout->is_registration_enabled() && $checkout->is_registration_required() && ! is_user_logged_in() ) {
	echo esc_html( apply_filters( 'woocommerce_checkout_must_be_logged_in_message', __( 'You must be logged in to checkout.', 'wan' ) ) );
	return;
}
...
<form name="checkout" method="post" class="checkout row woocommerce-checkout" action="<?php echo esc_url( wc_get_checkout_url() ); ?>" enctype="multipart/form-data">
	...
	<div id="order_review" class="woocommerce-checkout-review-order col-md-6">
		<div class="order_review_inner">
			<h4 id="order_review_heading"><?php esc_html_e( 'Your order', 'wan' ); ?></h3>
